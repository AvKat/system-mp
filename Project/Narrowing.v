...
Proof with eauto 4.
  ...
  1,3,4: apply (H0 x ltac:(fsetdec) ((x, bind_val S) :: E0) F z S0 S' ltac:(reflexivity)); auto;
         rewrite_alist (nil ++ (x, bind_val S) :: (E0 ++ (z, bind_val S') :: F));
        apply wf_env_weaken_val...

  (* Case w_tfun *)
  pick fresh X and apply w_tfun...
  apply (H0 X ltac:(fsetdec) ((X, bind_typ S) :: E0) F z S0 S' ltac:(reflexivity)); auto.
...
Proof with eauto 4.
  ...
  3: pick fresh x and apply w_pair...
  4: pick fresh x and apply w_tpair...
  1,3,4: apply (H0 x ltac:(fsetdec) ((x, bind_val S) :: E0) F z S0 S'); auto;
    rewrite_env (nil ++ (x, bind_val S) :: (E0 ++ (z, bind_typ S') :: F));
    apply wf_env_weaken_val...

  (* Case w_tfun *)
  pick fresh X and apply w_tfun...
  eapply (H0 X ltac:(fsetdec) ((X, bind_typ S) :: E0) F z S0 S'); auto.
  ...
  (* Case s_var *)
  analyze_binds b; constructor...

  (* Case s_tvar *)
  analyze_binds b...
  inversion BindsTacVal; subst...
  apply sub_trans with (T := S'); try constructor...
...
Theorem typing_narrow_val : forall E F z S S' e T,
  ...
  wf_env (E ++ (z, bind_val S') :: F) ->
  typing (E ++ (z, bind_val S') :: F) e T.
Proof with eauto 4 using wf_env_weaken_val, wf_typ_weaken_val, sub_weaken_val, wf_typ_narrow_val, sub_narrow_val.
  intros.
...
Theorem typing_narrow_typ : forall E F z S S' e T,
  ...
  wf_env (E ++ (z, bind_typ S') :: F) ->
  typing (E ++ (z, bind_typ S') :: F) e T.
Proof with eauto 4 using wf_env_weaken_typ, wf_typ_weaken_typ, sub_weaken_typ, wf_typ_narrow_typ, sub_narrow_typ.
  intros.
  dependent induction H...
  - pick fresh x and apply t_abs...
    eapply (H1 x ltac:(fsetdec) ((x, bind_val S0) :: E)); eauto.
